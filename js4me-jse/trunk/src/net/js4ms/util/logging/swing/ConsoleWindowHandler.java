...
public class ConsoleWindowHandler extends StreamHandler {
    ...
    public ConsoleWindowHandler() {
        ...
        String title = logManager.getProperty("net.js4ms.util.logging.swing.ConsoleWindowHandler.title");
        ...
        this.console = new Console(title,
                                   encoding,
                                   Boolean.parseBoolean(logManager.getProperty("net.js4ms.util.logging.swing.ConsoleWindowHandler.waitforclose")));
    }
