package net.js4ms.service.launcher.java;
...
public class ServiceLauncher {
    ...
    public static final String SERVICE_PORT_PROPERTY = "net.js4ms.service.socket.port";
    public static final String SERVICE_KEEP_ALIVE_ENABLED_PROPERTY = "net.js4ms.service.keepalive.enabled";
