 ...
 * 
 * File: IPv4Packet.java (net.js4ms.net.ip.ipv4)
 * 
...
import net.js4ms.net.ip.IPEndOfListOption;
import net.js4ms.net.ip.IPHeaderOption;
import net.js4ms.net.ip.IPMessage;
import net.js4ms.net.ip.IPPacket;
import net.js4ms.net.ip.IPPayload;
import net.js4ms.util.buffer.fields.BooleanField;
import net.js4ms.util.buffer.fields.ByteArrayField;
import net.js4ms.util.buffer.fields.ByteBitField;
import net.js4ms.util.buffer.fields.ByteField;
import net.js4ms.util.buffer.fields.FixedBufferField;
import net.js4ms.util.buffer.fields.ShortBitField;
import net.js4ms.util.buffer.fields.ShortField;
