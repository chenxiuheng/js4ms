 ...
 * 
 * File: IPv6Packet.java (net.js4ms.net.ip.ipv6)
 * 
...
import net.js4ms.net.ip.IPAuthenticationHeader;
import net.js4ms.net.ip.IPExtensionHeader;
...
import net.js4ms.util.buffer.fields.IntegerBitField;
