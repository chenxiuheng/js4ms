 ...
 * 
 * File: IPPacket.java (net.js4ms.net.ip)
 * 
...
import net.js4ms.util.buffer.BufferBackedObject;
import net.js4ms.util.buffer.fields.ByteBitField;
import net.js4ms.util.buffer.fields.Field;
import net.js4ms.util.buffer.fields.SelectorField;
import net.js4ms.util.buffer.parser.BufferParserSelector;
import net.js4ms.util.buffer.parser.KeyedBufferParser;
import net.js4ms.util.buffer.parser.KeyedStreamParser;
import net.js4ms.util.buffer.parser.MissingParserException;
import net.js4ms.util.buffer.parser.StreamParserSelector;
import net.js4ms.util.logging.Logging;



/**
 * Base class for the {@link net.js4ms.net.ip.ipv4.IPv4Packet IPv4Packet} and
 * {@link net.js4ms.net.ip.ipv6.IPv6Packet IPv6Packet} classes.
 * 
