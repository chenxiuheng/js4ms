 ...
 * 
 * File: AmtTunnelEndpoint.java (net.js4ms.net.amt.gateway)
 * 
...
package net.js4ms.net.amt.gateway;
...
import net.js4ms.net.amt.AmtMembershipQueryMessage;
import net.js4ms.net.amt.AmtMembershipUpdateMessage;
import net.js4ms.net.amt.AmtMessage;
import net.js4ms.net.amt.AmtMulticastDataMessage;
import net.js4ms.net.amt.AmtRelayAdvertisementMessage;
import net.js4ms.net.amt.AmtRelayDiscoveryMessage;
import net.js4ms.net.amt.AmtRequestMessage;
import net.js4ms.net.amt.AmtTeardownMessage;
import net.js4ms.net.ip.IPMessage;
import net.js4ms.net.ip.IPPacket;
import net.js4ms.net.ip.igmp.IGMPMessage;
import net.js4ms.net.ip.igmp.IGMPQueryMessage;
import net.js4ms.net.ip.igmp.IGMPv2ReportMessage;
import net.js4ms.net.ip.igmp.IGMPv3QueryMessage;
import net.js4ms.net.ip.igmp.IGMPv3ReportMessage;
import net.js4ms.net.ip.ipv4.IPv4Packet;
import net.js4ms.net.ip.ipv6.IPv6Packet;
import net.js4ms.net.ip.mld.MLDMessage;
import net.js4ms.net.ip.mld.MLDQueryMessage;
import net.js4ms.net.ip.mld.MLDv1ReportMessage;
import net.js4ms.net.ip.mld.MLDv2QueryMessage;
import net.js4ms.net.ip.mld.MLDv2ReportMessage;
import net.js4ms.net.udp.UdpDatagram;
import net.js4ms.net.udp.UdpInputChannel;
import net.js4ms.net.udp.UdpOutputChannel;
import net.js4ms.net.udp.UdpSocketEndpoint;
