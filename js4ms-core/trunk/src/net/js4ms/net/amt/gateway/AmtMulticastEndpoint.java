 ...
 * 
 * File: AmtMulticastEndpoint.java (net.js4ms.net.amt.gateway)
 * 
...
import net.js4ms.channels.MessageQueue;
import net.js4ms.channels.OutputChannel;
import net.js4ms.channels.OutputChannelPipe;
import net.js4ms.net.udp.MulticastEndpoint;
