 ...
 * 
 * File: AmtMembershipUpdateMessage.java (net.js4ms.net.amt)
 * 
...
import net.js4ms.net.ip.igmp.IGMPv2LeaveMessage;
import net.js4ms.net.ip.igmp.IGMPv3ReportMessage;
import net.js4ms.net.ip.mld.MLDMessage;
import net.js4ms.net.ip.mld.MLDv1DoneMessage;
