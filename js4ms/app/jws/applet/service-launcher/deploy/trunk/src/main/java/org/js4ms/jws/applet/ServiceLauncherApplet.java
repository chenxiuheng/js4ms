 ...
 * 
 * Copyright (C) 2011-2012 Cisco Systems, Inc.
 * 
...
public class ServiceLauncherApplet extends Applet {
    ...
    private static final String PARAMETER_INFO[][] = {
            ...
            { SERVICE_PORT_PARAM,
              "Integer",
              "The service port number. Passed to the service as property '" + ServiceLauncher.SERVICE_PORT_PROPERTY + "'" },
            { USE_KEEP_ALIVE_PARAM,
              "Boolean",
              "Indicates whether the applet should open a keep-alive connection. Passed to the service as property '" + ServiceLauncher.SERVICE_KEEP_ALIVE_ENABLED_PROPERTY + "'"  },
