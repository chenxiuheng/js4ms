...
public class Base64InputStream extends InputStream {
     ...
     * 
     * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
     * |               |x x x x x x y y|y y y y z z z z|z z w w w w w w|
     * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
     */
    @Override
                    ...
                    if (this.modulus != 0) {
                        ...
                        case 1:
                            ...
                            if (c == -1) {
                                ...
                                // Received an '=' with only one base64 character received since last byte was completed.
                                // Skip it and continue on and wait for a new character
                                continue;
                            }
                        }
                        this.modulus = 0;
