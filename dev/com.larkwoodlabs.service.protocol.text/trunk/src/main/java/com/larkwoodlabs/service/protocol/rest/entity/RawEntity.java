package com.larkwoodlabs.service.protocol.rest.entity;
...
import com.larkwoodlabs.service.protocol.rest.util.DateUtil;
...
public class RawEntity implements Entity {
    ...
    public InputStream getContent(final Codec codec) throws IOException {
        prepareContent();
        if (codec.getName().equals(this.contentEncoding)) {
