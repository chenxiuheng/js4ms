 ...
 * 
 * File: IPv4Packet.java (com.larkwoodlabs.net.ip.ipv4)
 * 
...
import com.larkwoodlabs.net.ip.IPPayload;
 ...
 *     of these three indications should be set.<p>
 * 
 *     The type of service is used to specify the treatment of the datagram
 *     during its distribution through the internet system.  Example
 ...
 *         +---+---+---+
 * </pre>
 *   <h2>Fragment Offset:  13 bits</h2>
 * 
 *     This field indicates where in the datagram this fragment belongs.
 *     The fragment offset is measured in units of 8 octets (64 bits).  The
 *     first fragment has offset zero.
 * 
 *   <h2>Time to Live:  8 bits</h2>
 * 
 ...
 *     datagram lifetime.
 * 
 *   <h2>Protocol:  8 bits</h2>
 * 
 *     This field indicates the next level protocol used in the data
 *     portion of the internet datagram.  The values for various protocols
 *     are specified in &quot;Assigned Numbers&quot; [9].
 * 
 *   <h2>Header Checksum:  16 bits</h2>
 * 
 *     A checksum on the header only.  Since some header fields change
 *     (e.g., time to live), this is recomputed and verified at each point
 *     that the internet header is processed.<p>
 *
 ...
 * 
 *   <h2>Source Address:  32 bits</h2>
 * 
 *     The source address.  See [RFC-791 Section 3.2].
 * 
 *   <h2>Destination Address:  32 bits</h2>
 * 
 *     The destination address.  See [RFC-791 Section 3.2].
 * 
 *   <h2>Options:  variable</h2>
 * 
 *     The options may appear or not in datagrams.  They must be
 *     implemented by all IP modules (host and gateways).  What is optional
 *     is their distribution in any particular datagram, not their
 *     implementation.
 * <p>
...
public final class IPv4Packet extends IPPacket {
    ...
    private void logState(final Logger logger) {
        ...
        if (this.unparsedOptions != null) {
            logger.info(ObjectId + " : unparsed options offset="+this.unparsedOptions.arrayOffset()+" limit="+this.unparsedOptions.limit());
        }
        ...
        if (this.unparsedPayload != null) {
            logger.info(ObjectId + " : unparsed payload offset="+this.unparsedPayload.arrayOffset()+" limit="+this.unparsedPayload.limit());
        }
    ...
    public void writeTo(final ByteBuffer buffer) {
        ...
        if (this.unparsedPayload != null) {
            ...
            IPMessage nextMessage = getFirstProtocolMessage();
            while (nextMessage != null) {
                // Create a separate view of the underlying bytes to use for writing the checksum (if any) in each protocol message
                slice = buffer.slice();
    ...
    /**
     * Gets current Maximize Throughput flag value. See
     * {@link #getTypeOfService()}. 
     * <pre>
     *    1
     *    0   1   2   3   4   5   6   7
    ...
    /**
     * Gets current Maximize Reliability flag value. See
     * {@link #getTypeOfService()}.
     * <pre>
     *    0   1   2   3   4   5   6   7
     *  +---+---+---+---+---+---+---+---+
