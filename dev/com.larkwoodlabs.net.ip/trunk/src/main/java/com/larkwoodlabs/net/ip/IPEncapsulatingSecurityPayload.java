 ...
 * 
 * File: IPEncapsulatingSecurityPayload.java (com.larkwoodlabs.net.ip)
 * 
 ...
 * <h2>2. Encapsulating Security Payload Packet Format</h2>
 ...
 * format, for all SAs.<p>
 * <dl>
 * <dt>2.1 Security Parameters Index<dd>
 * 
 ...
 *    MUST be part of the RFC.<p>
 * 
 *    Note that with regard to ensuring the alignment of the (real)
 *    ciphertext in the presence of an IV:<p>
 *    <ul> 
 *    <li>For some IV-based modes of operation, the receiver treats
 ...
 *    <li>In some cases, the receiver reads the IV in separately from
 ...
 *    </ul>
 * 
 * <dt>2.4 Padding (for Encryption)<dd>
 * 
 *    Several factors require or motivate use of the Padding field.<p>
 *    <ul> 
 *      <li>If an encryption algorithm is employed that requires the
 ...
 *          
 *      <li>Padding also may be required, irrespective of encryption
 ...
 * 
 *      <li>Padding beyond that required for the algorithm or alignment
 ...
 *    support generation and consumption of padding.<p>
 *    <ul>
 *           <li>For the purpose of ensuring that the bits to be encrypted
 ...
 *               fields.
 * 
 *           <li>For the purposes of ensuring that the Authentication Data
 ...
 *    padding values upon decryption.)<p>
 * 
 ...
 *    Numbers Authority (IANA).  The Next Header field is mandatory.<p>
 * 
 * <dt>2.7 Authentication Data<dd>
 * 
 ...
 *    rules and processing steps for validation.<p>
 * 
 * 
 * @author Gregory Bumgardner
 */
public class IPEncapsulatingSecurityPayload extends BufferBackedObject implements IPMessage {
