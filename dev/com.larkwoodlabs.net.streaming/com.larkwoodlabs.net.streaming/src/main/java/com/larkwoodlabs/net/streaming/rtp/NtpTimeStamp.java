 ...
 * @see java.util.Date
 */
public class NtpTimeStamp implements java.io.Serializable, Comparable<Object>
{
    ...
    */
     ...
     */
    public NtpTimeStamp(String s) throws NumberFormatException
    {
    ...
    {
        return compareTo((NtpTimeStamp) o);
    }
